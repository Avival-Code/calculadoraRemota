...
class Client(Iface):
    ...
    def subtract(self, number1, number2):
        ...
        """
        self.send_subtract(number1, number2)
        return self.recv_subtract()

    def send_subtract(self, number1, number2):
    ...
    def divide(self, number1, number2):
        ...
        """
        self.send_divide(number1, number2)
        return self.recv_divide()

    def send_divide(self, number1, number2):
...
class Processor(Iface, TProcessor):
    ...
    def process_subtract(self, seqid, iprot, oprot):
        ...
        result = subtract_result()
        try:
            result.success = self._handler.subtract(args.number1, args.number2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
    ...
    def process_divide(self, seqid, iprot, oprot):
        ...
        result = divide_result()
        try:
            result.success = self._handler.divide(args.number1, args.number2)
            msg_type = TMessageType.REPLY
        except TTransport.TTransportException:
            raise
        except TApplicationException as ex:
